<main class="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900 antialiased">
    <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
        <article
            ...
            <a href="{{ route('dashboard.index') }}" class="font-medium text-xs text-blue-500 text-decoration-none">
                    ...
                    <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                        ...
                        <div>
                            ...
                            <p class="text-base text-gray-500 dark:text-gray-400">
                                <time pubdate datetime="{{ date('Y-m-d', strtotime($post->created_at)) }}"
                                    title="{{ date('M j, Y', strtotime($post->created_at)) }}">
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <div class="flex justify-center items-center space-x-4">
                        ...
                        <form action="{{ route('dashboard.delete', ['post' => $post->slug]) }}" method="post">
                            @method('delete')
                            @csrf
                            <button type="submit"
