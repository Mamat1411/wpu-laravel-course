@foreach (['success', 'delete'] as $type)
    @if (session($type))
        <x-ui.toast :type="$type" :message="session($type)" />
    @endif
@endforeach
<!-- Start block -->
        ...
        <div class="bg-white dark:bg-gray-800 relative border sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div
                    ...
                    <a href="{{ route('dashboard.create') }}" id="createPostButton"
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        ...
                                        <div id="post-{{ $post->id }}-dropdown"
                                            ...
                                            <ul class="py-1 text-sm"
                                                ...
                                                <li>
                                                    <a href="{{ route('dashboard.edit', ['post' => $post->slug]) }}"
                                                        class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                                                        <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg"
                                                            viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                                            <path
                                            ...
                                            <div class="relative p-4 w-full max-w-md max-h-full">
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex justify-center items-center space-x-4">
                                                        ...
                                                        <form
                                                            action="{{ route('dashboard.delete', ['post' => $post->slug]) }}"
                                                            method="post">
                                                            @method('delete')
                                                            @csrf
                                                            <button type="submit"
