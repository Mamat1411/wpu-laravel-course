...
<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        {{-- Upload Avatar --}}
        <div>
            <label class="block mb-2 text-sm font-medium text-gray-700 dark:text-white" for="avatar">
                Upload Avatar
            </label>
            <input
                class="block w-full text-sm text-gray-900 border @error('avatar') bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500  dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 @enderror border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
