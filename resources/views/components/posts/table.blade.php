...
<section class="p-3 sm:p-5 antialiased">
    <h1 class="text-xl font-semibold pl-4 mb-3">Post By: {{ Auth::user()->name }}</h1>
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        ...
                                        <div id="post-{{ $post->id }}-dropdown"
                                            ...
                                            <ul class="py-1 text-sm"
                                                ...
                                                <li>
                                                    <a href="{{ route('dashboard.edit', ['post' => $post->slug]) }}" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                                                ...
                                                <li>
                                                    <a href="{{ route('dashboard.show', ['post' => $post->slug]) }}"
